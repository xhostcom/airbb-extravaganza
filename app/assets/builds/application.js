        ...
        (function() {
          (function() {
            ...
            this.LocalTime = { config: {}, run: function() {
              ...
              return this.controller != null ? this.controller : this.controller = new e.Controller();
            } };
          }).call(this);
        }).call(t);
        var e = t.LocalTime;
        (function() {
          (function() {
            ...
            r = !isNaN(Date.parse("2011-01-01T12:00:00-05:00")), e.parseDate = function(t3) {
              ...
              if (a = e2.match(t2))
                return a[0], c = a[1], o = a[2], n2 = a[3], r2 = a[4], i = a[5], u = a[6], l = a[7], l !== "Z" && (s = l.replace(":", "")), c + "/" + o + "/" + n2 + " " + r2 + ":" + i + ":" + u + " GMT" + [s];
            };
          }.call(this), function() {
            e.elementMatchesSelector = function() {
              var t2, e2, n, r, a, i;
              return t2 = document.documentElement, e2 = (n = (r = (a = (i = t2.matches) != null ? i : t2.matchesSelector) != null ? a : t2.webkitMatchesSelector) != null ? r : t2.mozMatchesSelector) != null ? n : t2.msMatchesSelector, function(t3, n2) {
            ...
            t2 = e.config, r = t2.i18n, e.getI18nValue = function(a, i) {
              var o, s;
              return a == null && (a = ""), o = (i != null ? i : { locale: t2.locale }).locale, s = n(r[o], a), s != null ? s : o !== t2.defaultLocale ? e.getI18nValue(a, { locale: t2.defaultLocale }) : void 0;
            }, e.translate = function(t3, n2, r2) {
              var a, i, o;
              n2 == null && (n2 = {}), o = e.getI18nValue(t3, r2);
              for (a in n2)
            ...
            t2 = e.getI18nValue, i = e.translate, e.strftime = a = function(e2, o) {
              ...
              var e2, n2, r2, a2, i2;
              return i2 = t3.toString(), (e2 = (n2 = i2.match(/\(([\w\s]+)\)$/)) != null ? n2[1] : void 0) ? /\s/.test(e2) ? e2.match(/\b(\w)/g).join("") : e2 : (e2 = (r2 = i2.match(/(\w{3,4})\s\d{4}$/)) != null ? r2[1] : void 0) ? e2 : (e2 = (a2 = i2.match(/(UTC[\+\-]\d+)/)) != null ? a2[1] : void 0) ? e2 : "";
            };
          }.call(this), function() {
            ...
            t2 = e.elementMatchesSelector, e.PageObserver = function() {
              ...
              return e2.prototype.start = function() {
                ...
                var n2;
                return n2 = [], (e3 != null ? e3.nodeType : void 0) === Node.ELEMENT_NODE && (t2(e3, this.selector) && n2.push(e3), n2.push.apply(n2, e3.querySelectorAll(this.selector))), n2;
            ...
            r = e.parseDate, a = e.strftime, n = e.getI18nValue, t2 = e.config, e.Controller = function() {
              ...
              return s = "time[data-local]:not([data-localized])", o.prototype.start = function() {
                ...
                if (e2 = t2.timerInterval)
                  return this.timer != null ? this.timer : this.timer = setInterval(this.processElements, e2);
              }, o.prototype.processElements = function(t3) {
                var e2, n2, r2;
                for (t3 == null && (t3 = document.querySelectorAll(s)), n2 = 0, r2 = t3.length; n2 < r2; n2++)
            ...
            a = false, t2 = function() {
              ...
              var e2;
              return (e2 = typeof requestAnimationFrame == "function" ? requestAnimationFrame(t3) : void 0) != null ? e2 : setTimeout(t3, 17);
            }, r = function() {
              var t3;
              return t3 = e.getController(), t3.start();
            }, e.start = function() {
              if (!a)
                return a = true, typeof MutationObserver != "undefined" && MutationObserver !== null || t2() ? r() : n(r);
...
%o`, message, error2, detail);
  ...
  // rails:/home/anton/Projects/airbb-extravaganza/app/javascript/controllers/**/*_controller.js
